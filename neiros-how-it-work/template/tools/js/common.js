...
$('.video-reviews-slider').slick({
	...
	prevArrow: '<button type="button" class="slick-prev"><svg class="svg-icon"><use xlink:href="/template/tools/img/sprite.svg#arrow-right"></use></svg></button>',
	nextArrow: '<button type="button" class="slick-next"><svg class="svg-icon"><use xlink:href="/template/tools/img/sprite.svg#arrow-right"></use></svg></button>',
	centerMode: true,
});
...
$(".js-where-can-use .js-tab-trigger").on("click", function () {
	$(".js-where-can-use .js-tab-trigger").removeClass("active");
	$(this).addClass("active");
	var e = $(this).attr("data-face"), o = e.split(".");
	$(".js-where-can-use .js-tab-content").addClass("no-active");
	for (var i = 0; i < o.length; i++) $('.js-where-can-use  .js-tab-content[data-face-block="' + o[i] + '"]').removeClass("no-active");
});


// ===========================================
$(".js-who-needs .js-tab-trigger").on("click", function () {
	$(".js-who-needs .js-tab-trigger").removeClass("active");
	$(this).addClass("active");
	var e = $(this).attr("data-face"), o = e.split(".");
	$(".js-who-needs .js-tab-content").addClass("no-active");
	for (var i = 0; i < o.length; i++) $('.js-who-needs .js-tab-content[data-face-block="' + o[i] + '"]').removeClass("no-active");
});
// ===========================================
...
$(".js-who-needs [data-face-block]").on("click", function () {
	var e = $(this).attr("data-face-block");
	$(window).width() > 991 && ($(".js-who-needs .js-tab-content").addClass("no-active"),
		$(".js-who-needs .js-tab-trigger").removeClass("active"),
		$(this).removeClass("no-active"),
		$(document).find(".js-who-needs .js-tab-trigger").each(function () {
			for (var o = $(this).attr("data-face"), i = o.split("."), l = 0; l < i.length; l++) i[l] == e && $(this).addClass("active")
		}))
});

new WOW().init();
$(document).on('click','.btnemailtest',function (){
if($('.emailtest').val()==''){
	window.location.href='https://neiros.cloud/register'
}else{
	window.location.href='https://neiros.cloud/register?email='+$('.emailtest').val()
}

});
$(document).on('click','.btrn',function (){
if($('.emailtest').val()==''){
	window.location.href='https://neiros.cloud/register'
}else{
	window.location.href='https://neiros.cloud/register?email='+$('.emailtest').val()
...
function ajax_load_for_menu_desc(){
...
$('.how-it-work-slider').slick({
	dots: true,
	dotsClass: 'how-it-work-slider__nav',
	prevArrow: '<button type="button" class="how-it-work-slider__btn how-it-work-slider__btn_prev"></button>',
	nextArrow: '<button type="button" class="how-it-work-slider__btn how-it-work-slider__btn_next"></button>',
	responsive: [
    {
      breakpoint: 992,
      settings: {
