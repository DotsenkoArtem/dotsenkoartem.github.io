...
document.addEventListener("DOMContentLoaded", () => {
  ...
  mobileMenuItemHasChildrenHandler(menu)
});
...
function mobileMenuItemHasChildrenHandler(menu) {
  let menuItemsHasChildren = Array.from(menu.querySelectorAll("li.menu-item-has-children"));
  menuItemsHasChildren.forEach((menuItemHasChildren)=>{

    let menuItemHasChildrenLink = menuItemHasChildren.querySelector("a");
    let subMenu = menuItemHasChildren.querySelector(".sub-menu");

    menuItemHasChildrenLink.addEventListener("click", function () {
      menuItemHasChildren.classList.toggle("open");
